  ...
  methods: {
    ...
    initBanNiang () {
      if (this.themeName.indexOf(this.currentTheme) === -1) {
        console.log('@idear-vuepress/kan-ban-niang不支持主题' + this.currentTheme + ', 请检查主题名, 或前往https://vuepress-theme-timi.recoluan.com/views/plugins/kanbanniang.html 查看支持的主题')
