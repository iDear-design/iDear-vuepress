  ...
  <div class="kanbanniang">
    <div class="banniang-container" v-show="isLoaded">
      ...
      <div
        ...
        <a target="_blank" href="https://vuepress-theme-ido.recoluan.com/views/plugins/kanbanniang.html">
  ...
  methods: {
    ...
    initBanNiang () {
      if (this.themeName.indexOf(this.currentTheme) === -1) {
        console.log('@ido-design/vuepress-plugin-kan-ban-niang不支持主题' + this.currentTheme + ', 请检查主题名, 或前往https://vuepress-theme-ido.recoluan.com/views/plugins/kanbanniang.html 查看支持的主题')
